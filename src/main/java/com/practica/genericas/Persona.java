...
public class Persona {
	...
	public static Persona crearPersona(String[] data) throws EmsInvalidNumberOfDataException {
		...
		String cp = data[6];
		String fechaNacimiento = data[7];
		return new Persona(nombre,apellidos,documento,email,direccion,cp,
				FechaHora.parsearFecha(fechaNacimiento));
	}
